...
def build_neck(args):
    if args.backbone in ('resnet18', 'resnet34'):
        args.in_channels_list=[64,128,256,512]; args.out_channels=128
    elif args.backbone in ('resnet50', 'resnet101', 'resnet152'):
        args.in_channels_list=[256,512,1024,2048]; args.out_channels=512

    norm_layer = nn.BatchNorm2d
    activation_layer = nn.ReLU

    neck = FeaturePyramidNetwork(args.in_channels_list, args.out_channels, norm_layer, activation_layer)
    return neck
